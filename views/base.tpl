...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<a class="nav navbar-nav navbar-right" style="margin-left: 2em" href="/register/">Register</a>
		</div>
		
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<a class="nav navbar-nav navbar-right" style="margin-left: 2em" href="/login/">Log in</a>
		</div>
	</nav>
	<div class="container">
		{{!base}}
